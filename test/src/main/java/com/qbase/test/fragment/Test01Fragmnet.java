...
public class Test01Fragmnet extends QBaseFg {
    ...
    public static Test01Fragmnet newInstance() {
        return new Test01Fragmnet();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView = view.findViewById(R.id.test_fragment01_recyclerView);
        return view;
    }
    ...
    private void initRecyclerView() {
        for (int i = 0; i < 20; i++) {
            ItemDatas.add("test Fragment01 : " + i);
        }
