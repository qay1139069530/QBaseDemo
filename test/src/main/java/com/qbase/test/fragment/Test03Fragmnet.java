...
public class Test03Fragmnet extends QBaseFg {
    ...
    public static Test03Fragmnet newInstance() {
        return new Test03Fragmnet();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView = view.findViewById(R.id.test_fragment03_recyclerView);
        return view;
    }
    ...
    private void initRecyclerView() {
        for (int i = 0; i < 20; i++) {
            ItemDatas.add("test Fragment03 : " + i);
        }
