 ...
 * tittle behavior
 */
public class TabTextBehavior extends ViewOffsetBehavior<View> {
    ...
    public TabTextBehavior() {
        init();
    }

    public TabTextBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        init();
    }
    ...
    public void onNestedPreScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull View child, @NonNull View target, int dx, int dy, @NonNull int[] consumed, int type) {
        ...
        if (target instanceof TextView) {//处理header滑动
