...
import com.qbase.auxilibrary.util.ThemeUtil;
...
/**
 * MyTabLayout provides a horizontal layout to display tabs.
 * <p/>
 * <p>Population of the tabs to display is
 * done through {@link Tab} instances. You create tabs via {@link #newTab()}. From there you can
 * change the tab's ic_label or icon via {@link Tab#setText(int)} and {@link Tab#setIcon(int)}
 ...
 * <p/>
 * <p>You can also add items to MyTabLayout in your layout through the use of {@link MyTabItem}.
 ...
 *
 *     &lt;android.support.design.widget.MainItem
...
public class MyTabLayout extends HorizontalScrollView {
    ...
    private static final int DEFAULT_GAP_TEXT_ICON = 1; // dps
     ...
     * Fixed tabs have equal width, based on the widest tab ic_label.
     *
     * @see #setTabMode(int)
     * @see #getTabMode()
     */
    ...
    private void addViewInternal(final View child) {
        if (child instanceof MyTabItem) {
            ...
            throw new IllegalArgumentException("Only MainItem instances can be added to TabLayout");
        }
    }
    ...
    public static final class Tab {
         ...
         * the entire string.
         *
         * @param count A resource ID referring to the text that should be displayed
         * @return The current instance for call chaining
         */
        @NonNull
        public Tab setCount(int count) {
            mCount = count;
            updateView();
            return this;
        }
    ...
    class TabView extends LinearLayout implements OnLongClickListener {
        ...
        private TableCircleView mCircleView;

        private View mCustomView;
        private TextView mCustomTextView;
        private ImageView mCustomIconView;
        private TableCircleView mCustomCircleView;
        ...
        final void update() {
            ...
            if (custom != null) {
                ...
                mCustomCircleView = new TableCircleView(getContext());
            } else {
            ...
            if (mCustomView == null) {
                ...
                if (mCustomCircleView == null) {
                    mCustomCircleView = new TableCircleView(getContext());
                }
                updateTextAndIcon(mTextView, mIconView, mCustomCircleView);
            } else {
                // Else, we'll see if there is a TextView or ImageView present and update them
                if (mCustomTextView != null || mCustomIconView != null) {
                    updateTextAndIcon(mCustomTextView, mCustomIconView, mCustomCircleView);
                }
            }
        ...
        private void updateTextAndIcon(@Nullable final TextView textView,
                                       ...
                                       @Nullable final TableCircleView circleView) {
            ...
            final int count = mTab != null ? mTab.getCount() : 0;
            ...
            if (count > 0) {
                ...
                circleView.setTargetView(iconView == null ? textView : iconView);
                circleView.setText(String.valueOf(count));
                circleView.setBadgeMargin(0, 5, 0, 0);
            } else {
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        ...
        // We return the default layout params so that we don't blow up if we're given a MainItem
