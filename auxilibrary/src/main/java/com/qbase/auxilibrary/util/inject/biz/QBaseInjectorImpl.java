...
import com.qbase.auxilibrary.util.inject.annotation.ContentView;
import com.qbase.auxilibrary.util.inject.annotation.Event;
import com.qbase.auxilibrary.util.inject.annotation.ViewInject;
 ...
 * 注解实现类
 * */
public final class QBaseInjectorImpl implements QBaseInjector {
    ...
    private static volatile QBaseInjectorImpl instance;

    private QBaseInjectorImpl() {
    }
    ...
    public static void registerInstance() {
        if (instance == null) {
            synchronized (lock) {
                if (instance == null) {
                    instance = new QBaseInjectorImpl();
                }
            }
        }
        QBaseInject.Ext.setViewInjector(instance);
    }

    @Override
    public void inject(View view) {
        injectObject(view, view.getClass(), new QBaseFinder(view));
    }
    ...
    public void inject(Activity activity) {
        ...
        injectObject(activity, handlerType, new QBaseFinder(activity));
    }

    @Override
    public void inject(Object handler, View view) {
        injectObject(handler, handler.getClass(), new QBaseFinder(view));
    }
    ...
    public View inject(Object fragment, LayoutInflater inflater, ViewGroup container) {
        ...
        // inject res & event
        injectObject(fragment, handlerType, new QBaseFinder(view));
    ...
    private static void injectObject(Object handler, Class<?> handlerType, QBaseFinder finder) {
